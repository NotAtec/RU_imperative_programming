...
string content [MAX_NO_OF_WORDS] = {};   // the read content of a text file (at most MAX_NO_OF_WORDS words)
...
int enter_command (string filename)
{// precondition:
    assert (true);
/*  postcondition:
...
int count_command (string content [], int no_of_words, string terms [], int no_of_terms)
{// precondition:
